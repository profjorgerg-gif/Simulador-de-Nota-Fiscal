...
export default function LandingGate({ children }) {
  ...
  return <main className="landing-a"><div className="landing-shade"/><section className="landing-hero"><div className="landing-brand"><img src={LOGO} alt="CEDUP Hermann Hering"/><div><strong>CEDUP HERMANN HERING</strong><span>Blumenau/SC</span><span>Curso Técnico em Administração e Contabilidade</span></div></div><div className="landing-copy"><span className="landing-kicker">PLATAFORMA DIDÁTICA</span><h1>Simulador<br/><em>NF-e/NFS-e</em></h1><p>Aprenda na prática a emissão de documentos fiscais eletrônicos simulados, com bases de cálculo, operações fiscais e as regras de transição do IBS e CBS, de forma simples e didática.</p><div className="landing-features"><div><b>▣ Emissão de documentos fiscais simulados</b><span>Ambiente didático para NF-e/NFS-e, sem validade fiscal.</span></div><div><b>▥ Regras IBS/CBS — 2026</b><span>Bases, alíquotas, valores e tratamento da transição tributária.</span></div><div><b>▤ Histórico completo</b><span>Visualização, PDF individual e salvamento em bloco.</span></div><div><b>◇ Aprendizado na prática</b><span>Aplicação voltada ao ensino técnico.</span></div></div><blockquote>“Formação técnica de qualidade para formar grandes profissionais.”</blockquote></div></section>
  <section className="landing-access"><div className="login-card"><div className="login-icon">🔒</div><h2>Entrar no sistema</h2><p>Entre com sua conta Google para acessar o Simulador NF-e/NFS-e.</p>
