...
export default function LandingGate({ children }) {
  ...
  async function entrar() {
    ...
    setEntrando(true);
    try {
      localStorage.setItem("sfd_perfil_acesso", "professor");
  ...
  return <main className="landing-a">
    <section className="landing-hero">
      ...
      <div className="landing-copy">
        ...
        <p>Aprenda na prática a emissão de NF-e, com bases de cálculo, operações fiscais e as regras de transição do IBS e CBS, de forma simples e didática.</p>
        ...
        <blockquote>“Formação técnica de qualidade para formar grandes profissionais.”</blockquote>
      </div>
    </section>
    ...
    <section className="landing-access">
      <div className="login-card">
        ...
        <button className="google-button" onClick={entrar} disabled={entrando}>
          <span>G</span>{entrando ? "Entrando..." : "Continuar com o Google"}
        </button>

        <div className="professor-note">
          <strong>Acesso exclusivo do professor</strong>
          <span>Plataforma destinada ao desenvolvimento das atividades didáticas.</span>
        </div>
    ...
    <footer className="landing-footer">
      <div>© 2026 Jorge Lima Cardoso. Todos os direitos reservados.</div>
      <div>Plataforma didática desenvolvida para o CEDUP Hermann Hering — Curso Técnico em Administração e Contabilidade.</div>
    </footer>
  </main>;
}
